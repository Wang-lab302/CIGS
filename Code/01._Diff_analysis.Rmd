...
for(j in 1: 20){
  ...
  write.csv(res,paste0(Dir_231_10,"/",unique(meta_231_10_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG_All.csv"))
  DEG<-subset(res,pvalue<0.05 & abs(log2FoldChange)>log2(1.5))
  DEG_num_231_10[k,]<-nrow(DEG)
  write.csv(DEG,file = paste0(Dir_231_10,"/", unique(meta_231_10_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG.csv"))
   k=k+1
   i=i+1
  }
...
for(j in 1: 20){
  ...
  write.csv(res,paste0(Dir_231_20,"/",unique(meta_231_20_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG_All.csv"))
  DEG<-subset(res,pvalue<0.05 & abs(log2FoldChange)>log2(1.5))
  DEG_num_231_20[k,]<-nrow(DEG)
  write.csv(DEG,file = paste0(Dir_231_20,"/", unique(meta_231_20_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG.csv"))
   k=k+1
   i=i+1
  }
  condition=factor(c(rep("DMSO",ncol(Counts_DMSO)),rep("JQ1",ncol(Counts_JQ1))),levels=c("DMSO","JQ1"))
...
for(j in 1: 20){
  ...
  write.csv(res,paste0(Dir_293T_10,"/",unique(meta_293T_10_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG_All.csv"))
  DEG<-subset(res,pvalue<0.05 & abs(log2FoldChange)>log2(1.5))
  DEG_num_293T_10[k,]<-nrow(DEG)
  write.csv(DEG,file = paste0(Dir_293T_10,"/", unique(meta_293T_10_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG.csv"))
   k=k+1
   i=i+1
  }
  condition=factor(c(rep("DMSO",ncol(Counts_DMSO)),rep("JQ1",ncol(Counts_JQ1))),levels=c("DMSO","JQ1"))
...
for(j in 1: 20){
  ...
  write.csv(res,paste0(Dir_293T_20,"/",unique(meta_293T_20_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG_All.csv"))
  DEG<-subset(res,pvalue<0.05 & abs(log2FoldChange)>log2(1.5))
  DEG_num_293T_20[k,]<-nrow(DEG)
  write.csv(DEG,file = paste0(Dir_293T_20,"/", unique(meta_293T_20_XL_2$Plate)[j],"_",unique(colnames(Counts_Drug))[i],"_DESeq2_DEG.csv"))
   k=k+1
   i=i+1
  }
  condition=factor(c(rep("DMSO",ncol(Counts_DMSO)),rep("JQ1",ncol(Counts_JQ1))),levels=c("DMSO","JQ1"))
